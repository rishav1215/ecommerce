...
<div class="container-fluid">
    ...
    <div class="col-12">
        <div class="card bg-dark text-white border-0 rounded-4 shadow">
            <img src="{{ asset('upload/products/banner.avif') }}" class="card-img object-fit-cover" alt="Banner" style="height: 400px; opacity: 0.8;">
            <div class="card-img-overlay d-flex align-items-center justify-content-center">
                <div class="text-center">
                    <h1 class="card-title display-3 fw-bold text-uppercase text-shadow">Summer Sale</h1>
                    <p class="card-text lead fs-4 mb-4">Up to <span class="fw-bold text-warning">50% OFF</span> on selected items</p>
            ...
            <div class="row">
                <div class="col-md-2 col-6 mb-3">
                    <div class="card h-100">
                        <img src="https://via.placeholder.com/200x150?text=Electronics" class="card-img-top" alt="Electronics">
